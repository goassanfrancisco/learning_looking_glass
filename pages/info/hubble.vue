<template>
  <page-container>
    ...
    <p>El telescopio tiene un peso total en torno a los 11.000 kilos. Es de forma cilíndrica, con una longitud de 13,2 m y un diámetro máximo de 4,2 metros.</p>

    <p>El telescopio Hubble es reflector y dispone de dos espejos, teniendo el principal 2,4 metros de diámetro. Para la exploración del cielo incorpora varios espectrómetros y tres cámaras, una de campo estrecho para fotografiar zonas pequeñas del espacio (de brillo débil por su lejanía), otra de campo ancho para obtener imágenes de planetas y una tercera infrarroja.</p>

    <p>La calidad de imagen se vio gravemente afectada por un espejo principal indebidamente asentado, pero este problema fue superado por una misión de reparación en diciembre de 1993.</p>
    ...
    <p>Ese mismo año tomó fotografías de gran calidad del cometa Shoemaker-Levy 9 en su senda de impacto hacia Júpiter.</p>

    <p>En 1995 tomó varias fotos instantáneas de una región cercana a la Osa Mayor, durante diez días consecutivos, y que al juntarse componen el “campo profundo del Hubble” con más de 3.000 objetos distintos.</p>

    <p>Ha tomado unas 500.000 fotografías del espacio exterior, suficiente material para llenar 1420 discos ópticos de 6,66 Gb cada uno. Se estima que con el Hubble se han observado más de un millón de objetos celestes.</p>

    <p>Gracias al Hubble se han podido estudiar las cefeidas, un grupo de estrellas de luminosidad variable en términos periódicos, lo cual fue fundamental para determinar la edad aproximada del universo.</p>
    ...
    <p>"Webb se dedica a observar el Universo con luces infrarrojas, mientras que el Hubble continuará estudiando principalmente en longitudes de onda ópticas y ultravioletas, aunque tiene cierta capacidad de infrarrojos", señaló la NASA.</p>
    ...
    <p>Además, sus cuatro instrumentos científicos para capturar imágenes y espectros de objetos astronómicos proporcionarán una cobertura de longitud de onda de 0.6 a 28 micrómetros. Los instrumentos del Hubble pueden observar una pequeña porción del espectro infrarrojo de 0.8 a 2.5 micrones, pero sus capacidades principales se encuentran en las partes ultravioleta y visible del espectro de 0.1 a 0.8 micrones.</p>

    <p>Que el James Webb observe el universo con espectro infrarrojo le permite revelar los estados fríos de la materia, así como objetos sólidos en el espacio, lo que le ayuda a captar mejores imágenes a detalle del universo.</p>
