<template>
  <page-container>
    ...
    <paragraph>Cuando los investigadores separan la luz de una galaxia individual en un espectro, como el gráfico que se muestra arriba, pueden aprender sobre la composición química, la temperatura y la densidad del gas ionizado de la galaxia. Por ejemplo, el espectro de esta galaxia revelará las propiedades de su gas, lo que indicará cómo se están formando sus estrellas y cuánto polvo contiene. Estos datos nunca antes se habían detectado desde tan lejos con esta calidad.</paragraph>

    <paragraph>A medida que los astrónomos comiencen a analizar los datos de Webb, aprenderemos mucho sobre las galaxias que existieron a lo largo del tiempo cósmico, y cómo se comparan con las hermosas galaxias espirales y elípticas del universo cercano.</paragraph>
