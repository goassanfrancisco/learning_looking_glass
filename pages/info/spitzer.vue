<template>
  <page-container>
    ...
    <p>El observatorio Spitzer consiste en un telescopio de 0.85 metros con tres instrumentos científicos enfriados criogénicamente, capaces de tomar imágenes y espectros de 3 a 180 micras: IRAC (La Cámara de Arreglo Infrarrojo), IRS (El Espectrógrafo Infrarrojo) y MIPS (El Fotómetro de Imágenes en Multibanda).</p>
    ...
    <p>Brindó información de galaxias comúnmente llamadas "big babies". Hasta entonces, los científicos creían que las galaxias grandes y modernas se formaron a través de la fusión gradual de galaxias más pequeñas. Pero las galaxias 'big baby' demostraron que las colecciones masivas de estrellas se juntaron muy temprano en la historia del universo.</p>

    <p>El telescopio capturó una colisión rocosa en sistemas solares distintos. La agencia asegura que este tipo de fenómenos en el espacio son muy comunes, puesto que el Sistema Solar en el que habita el planeta Tierra tuvo su propia colisión y fue esencial para la creación de los planetas.</p>

    <p>Fue el primer telescopio en capturar imágenes de la atmosfera de un exoplaneta.</p>

    <p>Los agujeros negros supermasivos acechan en los núcleos de la mayoría de las galaxias. El telescopio Spitzer capturó dos de los agujeros más distantes jamás descubiertos; expertos suponen que se formaron en mil millones de años después del nacimiento del universo.</p>
    ...
    <p>MIRI, el instrumento de infrarrojo medio, es la cámara más fría de Webb. Esta imagen de prueba muestra parte de la Gran Nube de Magallanes, una pequeña galaxia satélite de la Vía Láctea que proporciona un denso campo de estrellas con el que probar el rendimiento de Webb.</p>

    <p>Webb tiene un espejo primario significativamente más grande y detectores mejorados que le permiten capturar imágenes con una claridad significativamente mejor que la que pudo Spitzer. En esta imagen de comparación, la imagen MIRI de Webb (a 7,7 micrones) muestra el gas interestelar con un detalle notable, mucho más que el disponible con Spitzer (a 8,0 micrones).</p>

    <p>Se puede ver la emisión de 'hidrocarburos aromáticos policíclicos' o moléculas de carbono e hidrógeno que juegan un papel importante en el equilibrio térmico y la química del gas interestelar. Webb ayudara a los astrónomos a comprender mejor el nacimiento de las estrellas y los sistemas protoplanetarios.</p>
